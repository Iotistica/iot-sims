...
class LearnedTwinSimulationProvider(SimulationProvider):
    """Scaffold for a future autonomous learned simulation model."""
    ...
    def validate(self) -> ValidationResult:
        return ValidationResult(valid=False, errors=["No learned model configured"])
